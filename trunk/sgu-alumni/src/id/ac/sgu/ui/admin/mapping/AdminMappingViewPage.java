...
public class AdminMappingViewPage extends BasePage
{
	//private static Logger logger = Logger.getLogger(AdminMappingViewPage.class);

	private UserBean bean;

	private List<UserBean> beanList;

	public AdminMappingViewPage()
	{
		try
		{
			bean = new UserBean();
			...
			AdminMappingViewForm adminMappingViewForm = new AdminMappingViewForm(
					"adminMappingViewForm", model, null);

			add(initNavigationBorder(adminMappingViewForm));
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	public AdminMappingViewPage(PageParameters pageParameters)
	{
		...
		AdminMappingViewForm adminMappingViewForm = new AdminMappingViewForm(
				"adminMappingViewForm", model, pageParameters);

		add(initNavigationBorder(adminMappingViewForm));
	}

	private class AdminMappingViewForm extends Form<UserBean>
	{
		...
		public AdminMappingViewForm(String id, IModel<UserBean> model, PageParameters pageParameters)
		{
			super (id, model);
